...
<head>
    ...
    <title>Página del camarero</title>
</head>
    ...
    <div class="container">
        ...
        <div class="content-gestion">
            <div class="row content-gestion-header">
                ...
                <div class="column-5 content-gestion-header-return" onclick="window.location.href='./camarero.php'">
                    <h1>Atrás</h1>
                </div>
            </div>

            <form name="formMesa" id="formMesa" action="./cambiarEstadoMesa-camarero.php" method="GET">
            ...
            <div class="row content-gestion-content">
                ...
                if (isset($room_id)) { // imprimir mesas de sala
                    ...
                    foreach ($resultado_salas as $sala) {
                        echo '
                            <div class="column-5 content-gestion-content-item" onclick="window.location.href= \'camarero.php?room=' . $sala["room_id"] . '\'">
                                <div class="content-gestion-content-item-image">
